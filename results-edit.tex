...
We test (---- vision model) on data collected after the training images                                                
...
and we compare to satellite ground truth. For each of snow and vegetation, we present two kinds of results:
...
( -- just a cool illustration on top right of first page?)
...
\subsection{Vision model -- Vegetation classification}
...
\hfill \break
\hfill \break
\subsection*{workshop -- Snow detection}
