...
Using the method we describe in~\ref{sec:methods}, we train and test the vision model on our hand-labeled data set. And we present the results on image classification level.
