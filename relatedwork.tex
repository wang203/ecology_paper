...
~\cite{Leafsnap: A Computer Vision System for Automatic Plant Species Identification} identifies plant species by leaf images. They focus on accurate leaf segmentation according to color difference of leaf and background, curvature distribution over scale, and nearest neighbor matching.
